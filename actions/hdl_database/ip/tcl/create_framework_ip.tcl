...
set_property -dict [list CONFIG.NUM_SLAVE_PORTS {12} \
...
CONFIG.S03_AXI_DATA_WIDTH {512} \
CONFIG.S04_AXI_DATA_WIDTH {512} \
CONFIG.S05_AXI_DATA_WIDTH {512} \
CONFIG.S06_AXI_DATA_WIDTH {512} \
CONFIG.S07_AXI_DATA_WIDTH {512} \
CONFIG.S08_AXI_DATA_WIDTH {512} \
CONFIG.S09_AXI_DATA_WIDTH {512} \
CONFIG.S10_AXI_DATA_WIDTH {512} \
CONFIG.S11_AXI_DATA_WIDTH {512} \
...
set_property -dict [list CONFIG.NUM_MI {13} \
CONFIG.PROTOCOL {AXI4LITE} \
CONFIG.M00_A00_BASE_ADDR {0x0000000000000200} \
CONFIG.M01_A00_BASE_ADDR {0x0000000000000300} \
CONFIG.M02_A00_BASE_ADDR {0x0000000000000400} \
CONFIG.M03_A00_BASE_ADDR {0x0000000000000500} \
CONFIG.M04_A00_BASE_ADDR {0x0000000000000600} \
CONFIG.M05_A00_BASE_ADDR {0x0000000000000700} \
CONFIG.M06_A00_BASE_ADDR {0x0000000000000800} \
CONFIG.M07_A00_BASE_ADDR {0x0000000000000900} \
CONFIG.M08_A00_BASE_ADDR {0x0000000000000A00} \
CONFIG.M09_A00_BASE_ADDR {0x0000000000000B00} \
CONFIG.M10_A00_BASE_ADDR {0x0000000000000C00} \
CONFIG.M11_A00_BASE_ADDR {0x0000000000000D00} \
CONFIG.M12_A00_BASE_ADDR {0x0000000000000000} \
CONFIG.M00_A00_ADDR_WIDTH {8} \
CONFIG.M01_A00_ADDR_WIDTH {8} \
CONFIG.M02_A00_ADDR_WIDTH {8} \
CONFIG.M03_A00_ADDR_WIDTH {8} \
CONFIG.M04_A00_ADDR_WIDTH {8} \
CONFIG.M05_A00_ADDR_WIDTH {8} \
CONFIG.M06_A00_ADDR_WIDTH {8} \
CONFIG.M07_A00_ADDR_WIDTH {8} \
CONFIG.M08_A00_ADDR_WIDTH {8} \
CONFIG.M09_A00_ADDR_WIDTH {8} \
CONFIG.M10_A00_ADDR_WIDTH {8} \
CONFIG.M11_A00_ADDR_WIDTH {8} \
CONFIG.M12_A00_ADDR_WIDTH {8} \
] [get_ips host_axi_lite_crossbar_0] >> $log_file
