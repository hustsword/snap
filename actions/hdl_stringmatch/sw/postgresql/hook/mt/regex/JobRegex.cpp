...
JobRegex::JobRegex (int in_id, int in_buf_id)
...
JobRegex::JobRegex (int in_id, int in_buf_id, HardwareManagerPtr in_hw_mgr)
...
JobRegex::JobRegex (int in_id, int in_buf_id, HardwareManagerPtr in_hw_mgr, bool in_debug)
...
void JobRegex::set_src (void* in_src)
{
    m_src = in_src;
}

void JobRegex::set_dest (void* in_dest)
{
    m_dest = in_dest;
}

void JobRegex::set_size (size_t in_size)
{
    m_size = in_size;
}
...
void* JobRegex::aalloc (int align, int size)
{
    void* a;
...
int JobRegex::allocate (size_t in_size)
{
