...
/* Header file for SNAP Framework SNAP_EXAMPLE_VLOG code */
#define ACTION_TYPE_SNAP_EXAMPLE_VLOG     0x00000001	/* Action Type */
...
#define NUM_SNAP_EXAMPLE_VLOG_PIPELINE       512
